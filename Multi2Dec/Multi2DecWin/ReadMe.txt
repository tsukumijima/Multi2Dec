================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: Multi2DecWin プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した Multi2DecWin には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには Multi2DecWin アプリケーションを構成している各ファイ
ルの概要説明が含まれます。
...
Multi2DecWin.h
   ...
   CMulti2DecWinApp アプリケーション クラスを宣言します。

Multi2DecWin.cpp
   これは、アプリケーション クラス CMulti2DecWinApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\Multi2DecWin.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル Multi2DecWin.rc に含まれていま
   す。

res\Multi2DecWin.rc2
...
Multi2DecWinDlg.h, Multi2DecWinDlg.cpp - ダイアログ
   これらのファイルは CMulti2DecWinDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な Multi2DecWin.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   Multi2DecWin.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
